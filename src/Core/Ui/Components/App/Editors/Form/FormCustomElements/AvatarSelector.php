...
class AvatarSelector extends VueUiComponent {
    ...
    public function mainAction(){
        ...
        $this->setJsDataVar("uploadImagePath", $this->getDI()->get('config')->files->images->avatarModel);
    ...
    public function uploadService(){
        ...
        if($this->hasJsonParam()){
            ...
            if(isset($param["name"]) && isset($param["mimetype"]) && isset($param["size"]) && isset($param["path"]) && isset($param["image"])){
                ...
                $imageDataSourceOptions["model"]    = $this->getDI()->get('config')->files->images->avatarModel;
